...
{
    public static Winkompass_Mobil.Controllers.HomeController Home = new Winkompass_Mobil.Controllers.T4MVC_HomeController();
    public static Winkompass_Mobil.Controllers.OrderController Order = new Winkompass_Mobil.Controllers.T4MVC_OrderController();
    public static Winkompass_Mobil.Controllers.PurchaseController Purchase = new Winkompass_Mobil.Controllers.T4MVC_PurchaseController();
    public static Winkompass_Mobil.Controllers.SharedController Shared = new Winkompass_Mobil.Controllers.T4MVC_SharedController();
    public static Winkompass_Mobil.Controllers.StorageController Storage = new Winkompass_Mobil.Controllers.T4MVC_StorageController();
}
...
namespace Links
{
    ...
    public static class Content {
        ...
        public static readonly string getmdl_select_min_css = Url("getmdl-select.min.css");
        public static readonly string getmdl_select_min_js = Url("getmdl-select.min.js");
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public static class images {
            ...
            public static readonly string back2_png = Url("back2.png");
            public static readonly string home_png = Url("home.png");
        }
    
        public static readonly string jquery_1_3_1_min_js = Url("jquery-1.3.1.min.js");
        public static readonly string mdl_jquery_modal_dialog_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/mdl-jquery-modal-dialog.min.css") ? Url("mdl-jquery-modal-dialog.min.css") : Url("mdl-jquery-modal-dialog.css");
        public static readonly string mdl_jquery_modal_dialog_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/mdl-jquery-modal-dialog.min.js") ? Url("mdl-jquery-modal-dialog.min.js") : Url("mdl-jquery-modal-dialog.js");
        public static readonly string mdl_selectfield_min_css = Url("mdl-selectfield.min.css");
        public static readonly string mdl_selectfield_min_js = Url("mdl-selectfield.min.js");
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public static class mdl_v1_1_2 {
            private const string URLPATH = "~/Content/mdl-v1.1.2";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            ...
            public static readonly string material_min_css = Url("material.min.css");
            public static readonly string material_min_css_map = Url("material.min.css.map");
        ...
        public static readonly string NormalScan_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/NormalScan.min.js") ? Url("NormalScan.min.js") : Url("NormalScan.js");
        public static readonly string Site_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/Site.min.css") ? Url("Site.min.css") : Url("Site.css");
        public static readonly string Site5_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/Site5.min.css") ? Url("Site5.min.css") : Url("Site5.css");
    }
    ...
    public static partial class Bundles
    {
        ...
        public static partial class Content 
        {
            ...
            public static partial class mdl_v1_1_2 
            {
                public static class Assets
                {
                    public const string material_css = "~/Content/mdl-v1.1.2/material.css";
                    public const string material_js = "~/Content/mdl-v1.1.2/material.js"; 
                    public const string material_min_css = "~/Content/mdl-v1.1.2/material.min.css";
                    public const string material_min_js = "~/Content/mdl-v1.1.2/material.min.js"; 
                }
            }
            public static class Assets
            {
                ...
                public const string getmdl_select_min_css = "~/Content/getmdl-select.min.css";
                public const string getmdl_select_min_js = "~/Content/getmdl-select.min.js"; 
                public const string jquery_1_3_1_min_js = "~/Content/jquery-1.3.1.min.js"; 
                public const string mdl_jquery_modal_dialog_css = "~/Content/mdl-jquery-modal-dialog.css";
                public const string mdl_jquery_modal_dialog_js = "~/Content/mdl-jquery-modal-dialog.js"; 
                public const string mdl_selectfield_min_css = "~/Content/mdl-selectfield.min.css";
                public const string mdl_selectfield_min_js = "~/Content/mdl-selectfield.min.js"; 
                public const string NormalScan_js = "~/Content/NormalScan.js"; 
                public const string Site_css = "~/Content/Site.css";
                public const string Site5_css = "~/Content/Site5.css";
            }
        }
    }
}
